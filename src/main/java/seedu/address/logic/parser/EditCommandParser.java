...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        if (argMultimap.getValue(PREFIX_MEASUREMENT).isPresent()) {
            editPersonDescriptor.setMeasurement(ParserUtil.parseMeasurement(
                   argMultimap.getValue(PREFIX_MEASUREMENT).get())
            );
        }
